...
tree = Node(Node(None, Node(None, Node(None, None))),
            Node(Node(Node(None, Node(None, Node(None, Node(None, None)))), None), None))

tree = Node(None, Node(Node(None, None), Node(
    None, Node(Node(None, None), None))))

tree = Node(None, Node(Node(None, None), Node(None, Node(None, None))))
